        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    default_status_id = table.Column<Guid>(type: "uuid", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    created_by = table.Column<Guid>(type: "uuid", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    updated_by = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    color = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "#808080"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_workflow_statuses_projects_project_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoAssignUserId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusTransitions_workflow_statuses_FromStatusId",
                        column: x => x.FromStatusId,
                        principalTable: "workflow_statuses",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatusTransitions_workflow_statuses_ToStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    friendly_id_prefix = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    friendly_id_number = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tasks_workflow_statuses_status_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_task_history_users_changed_by_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_projects_workspace_id_prefix",
                table: "projects",
                columns: new[] { "workspace_id", "prefix" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_task_history_changed_at",
                table: "task_history",
                column: "changed_at");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_workflow_statuses_project_id_order",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_projects_workflow_statuses_default_status_id",
                table: "projects",
                column: "default_status_id",
                principalTable: "workflow_statuses",
                principalColumn: "id",
